# Figure 16
- Code used to conduct FLMM analyses for Figure 16 are in "science_background_rewards.R"  -- Using this file requires one to download data from the repository listed below.
